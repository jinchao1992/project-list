...
var removeNode = function removeNode(list, node) {
  ...
  prevTemp.next = temp.next; // if (list === node) {
  //   // 如果删除的是第1个节点
  //   list = node.next
  // } else {
  //   if (list.next === node) {
...
var setList = function setList(list, index) {
  var temp = list;
  var n = 1;
...
var node4 = appendList(list, 40); // removeNode(list, node2)
// traveList(list, (node) => {
//   console.log(node.data)
// })

var setNode = setList(list, 2);
console.log(setNode); // console.log('list')
// console.log(list)
